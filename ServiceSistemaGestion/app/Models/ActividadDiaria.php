...
class ActividadDiaria extends Model
{
  ...
  public function getDataActividadesTecnico($id){
    return $colmena = DB::table('tbl_actividaddiaria as T0')
          ...
          ->select('T1.fecha','T0.id_act','T0.n9cono','T0.n9cocu','T0.n9cose','T0.n9coru','T0.n9plve','T0.n9vaca','T0.n9meco','T0.n9leco','T0.n9cocl','T0.n9nomb','T0.n9refe','T0.cusecu','T0.cucoon','T0.cucooe','T1.estado','T1.tipo_actividad','T1.observacion')
          ->where('T1.id_tecn',$id)
          ->where('T0.estado',1)
          ->where('T1.estado',0)
